@echo off
echo Committing final JSON leakage fix to Coda Lite repository...
...
git commit -m "Implement final JSON leakage fix with aggressive cleaning and improved prompts (v0.0.8)"
