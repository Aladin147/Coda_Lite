...
def register_tools(router):
    ...
    router.register_tool(
        "get_memory_stats",
        get_memory_stats,
        aliases=["memory_stats", "show_memory_stats"],
    ...
    router.register_tool(
        "add_fact",
        add_fact,
        aliases=["remember_fact", "remember"],
    ...
    router.register_tool(
        "add_preference",
        add_preference,
        aliases=["remember_preference", "set_preference"],
    ...
    router.register_tool(
        "get_user_summary",
        get_user_summary,
        aliases=["user_profile", "what_do_you_know_about_me"],
    ...
    router.register_tool(
        "search_memories",
        search_memories,
        aliases=["search_memory", "find_memories"],
    ...
    router.register_tool(
        "forget_session",
        forget_session,
        aliases=["reset_memory", "forget_conversation"],
